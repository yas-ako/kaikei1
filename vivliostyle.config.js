module.exports = {
  title: 'kaikei1', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: '都立桜修館中等教育学校 75期記念祭幹部 会計班', // default to `author` in `package.json` or undefined.
